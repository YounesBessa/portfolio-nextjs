      ...
      <div className='max-w-[1240px] w-full h-full mx-auto p-2 flex justify-center items-center'>
        <div>
          ...
          <h1 className='py-4 text-gray-700 dark:text-white'>
            Hi, I&#39;m <span className='text-[#5651e5]'> Younes</span>
          </h1>
          ...
          <div className='flex items-center justify-between max-w-[330px] m-auto py-4'>
            <a
              ...
              rel='noreferrer'
            >
              <div className='rounded-full shadow-lg shadow-gray-400 dark:bg-white p-6 cursor-pointer hover:scale-110 ease-in duration-300'>
                <FaLinkedinIn />
              </div>
            </a>
            <a
