...
import githubImg from '../public/assets/projects/github.png';
...
const crypto = () => {
  return (
    <div className='w-full'>
      ...
      <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8 dark:text-white'>
        <div className='col-span-4'>
          ...
          <a
            href='https://github.com/YounesBessa?tab=repositories'
            target='_blank'
            rel='noreferrer'
          >
        ...
        <div className='col-span-4 md:col-span-1 shadow-xl shadow-gray-400 rounded-xl py-4 dark:bg-white'>
          <div className='p-2'>
            <p className='text-center font-bold pb-2 dark: text-gray-600'>Technologies</p>
